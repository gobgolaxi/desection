...
-- Остальные методы остаются без изменений (Dragify, MakeResizable, ToggleTheme, UpdateTheme, ToggleMinimize, Close, AddCategory, SwitchCategory)
